...
#ifndef SHARED_INTERFACES__MSG__DETAIL__BATTERY_STATUS__FUNCTIONS_H_
#define SHARED_INTERFACES__MSG__DETAIL__BATTERY_STATUS__FUNCTIONS_H_
 ...
 * )) before or use
 * shared_interfaces__msg__BatteryStatus__create()
 ...
 * calls
 * shared_interfaces__msg__BatteryStatus__init().
...
/**
 * It calls
 * shared_interfaces__msg__BatteryStatus__fini()
 ...
 * shared_interfaces__msg__BatteryStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * shared_interfaces__msg__BatteryStatus__Sequence__fini()
 * on the array,
...
#endif  // SHARED_INTERFACES__MSG__DETAIL__BATTERY_STATUS__FUNCTIONS_H_
