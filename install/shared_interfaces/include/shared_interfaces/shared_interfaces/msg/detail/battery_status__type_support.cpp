...
{
  new (message_memory) shared_interfaces::msg::BatteryStatus(_init);
}

void BatteryStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<shared_interfaces::msg::BatteryStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BatteryStatus_message_member_array[3] = {
  {
    ...
    offsetof(shared_interfaces::msg::BatteryStatus, voltage),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shared_interfaces::msg::BatteryStatus, current),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shared_interfaces::msg::BatteryStatus, percentage),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BatteryStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(shared_interfaces::msg::BatteryStatus),
...
get_message_type_support_handle<shared_interfaces::msg::BatteryStatus>()
{
  return &::shared_interfaces::msg::rosidl_typesupport_introspection_cpp::BatteryStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, shared_interfaces, msg, BatteryStatus)() {
  return &::shared_interfaces::msg::rosidl_typesupport_introspection_cpp::BatteryStatus_message_type_support_handle;
}
